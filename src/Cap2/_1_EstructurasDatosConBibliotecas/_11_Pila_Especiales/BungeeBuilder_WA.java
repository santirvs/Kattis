...
public class BungeeBuilder_WA {
    ...
    static final int BUSCANDO_VALLE = 2;
    static final int BUSCANDO_EXTREMO = 3;
        ...
        for (int i=0; i<numMontes; i++) {
            ...
            if (estado == BUSCANDO_PICO) {
                if (altura > alturaMaxima) {
                    ...
                    nivelValle = Integer.MAX_VALUE;
                    picoMaximo = 0;
                    estado = BUSCANDO_VALLE;
                }
            }
            else if (estado == BUSCANDO_VALLE) {
                if (altura > anterior) {
                    //Encontrado el valle, empiezo a buscar el otro extremo
