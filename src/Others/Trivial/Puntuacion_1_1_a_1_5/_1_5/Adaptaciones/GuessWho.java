package Others.Trivial.Puntuacion_1_1_a_1_5._1_5.Adaptaciones;
...
// Finalmente imprimir: "SI" y el número de personaje
// o bien "NO" con la cantidad de personajes posibles
...
public class GuessWho {
    ...
    public static void main(String[] args) {
        ...
        // o bien "NO" con la cantidad de personajes posibles
        if (candidatos == 1) {
            System.out.println("SI " + candidatoElegido);
        } else {
            System.out.println("NO " + candidatos);
        }
