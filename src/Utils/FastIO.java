...
public class FastIO {
    ...
    public static void main(String[] args) {
        ...
        // Exemple d'ús
        // Llegir un número (num casos de prova), Llegir n noms (poden ser compostos)

        int numCasos = fr.nextInt();   // No ha calgut llegir el salt de línia extra!!!
        while (numCasos-- > 0) {
            String s = fr.nextLine();
            out.println("Leído: " + s);
        }
        out.close(); // ¡No olvides cerrar el PrintWriter para que imprima!
    }
}
